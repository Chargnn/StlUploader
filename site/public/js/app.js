...
var AColorPicker = __webpack_require__(/*! a-color-picker */ "./node_modules/a-color-picker/dist/acolorpicker.js");

var picker = AColorPicker.from('div.color-picker');
picker.on('change', function (picker, color) {
  document.getElementById('tags-color').value = AColorPicker.parseColor(color, 'hex');
});
...
__webpack_require__(/*! /home/acoulombe/code/StlUploader/site/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/acoulombe/code/StlUploader/site/resources/sass/app.scss */"./resources/sass/app.scss");
